...
export class BookInstanceService {
    constructor(
        @InjectRepository(BookInstance) private book_instance_repository: Repository<BookInstance>
    ) { }
    ...
    create(isbn: string, body: any) {
        ...
        let instance: BookInstance = this.book_instance_repository.create(dto);
        instance.id = uuid()
